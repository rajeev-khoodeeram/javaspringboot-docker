...
public class ProductControllerTest {
    ...
    void testGetAllProducts() throws Exception {
        ...
        // This test will verify that the getAllProducts method returns a list of
        // products
        // You can use mockMvc to perform a GET request and verify the response
        // For example, you can check if the response status is OK and if the returned
        // list is not empty
    ...
    void testGetProduct() throws Exception {
        ...
        // For example, you can check if the response status is OK and if the returned
        // product has the expected properties
     ...
     * // This test will verify that the getProduct method returns a 404 status when
    ...
    void testAddProduct() throws Exception {
        // This test will verify that the addProduct method adds a new product
        // successfully
        // You can use mockMvc to perform a POST request with a product object in the
        // request
    ...
    void testAddProductInvalid() throws Exception {
        // This test will verify that the addProduct method returns a 400 status when
